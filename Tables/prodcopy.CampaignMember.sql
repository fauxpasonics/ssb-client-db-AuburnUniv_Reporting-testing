...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__CampaignM__CopyL__46E78A0C] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[CampaignMember] ADD CONSTRAINT [PK__Campaign__3214EC079B164BA2] PRIMARY KEY CLUSTERED  ([Id])
GO
