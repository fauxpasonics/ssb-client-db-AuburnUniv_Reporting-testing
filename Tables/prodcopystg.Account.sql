...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Account__copyloa__0F975522] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopystg].[Account] ADD CONSTRAINT [PK__Account__3214EC07DD9C4289] PRIMARY KEY CLUSTERED  ([Id])
GO
