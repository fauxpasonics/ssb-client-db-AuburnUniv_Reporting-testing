...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Opportuni__copyl__4F7CD00D] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Opportunity] ADD CONSTRAINT [PK__Opportun__3214EC073DCC86B6] PRIMARY KEY CLUSTERED  ([Id])
GO
