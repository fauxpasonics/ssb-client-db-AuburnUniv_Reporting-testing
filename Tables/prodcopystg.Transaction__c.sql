...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Transacti__copyl__398D8EEE] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Transaction__c] ADD CONSTRAINT [PK__Transact__3214EC0705FD27DD] PRIMARY KEY CLUSTERED  ([Id])
GO
