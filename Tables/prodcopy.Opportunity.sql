...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Opportuni__copyl__52593CB8] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Opportunity] ADD CONSTRAINT [PK__Opportun__3214EC07797B27EE] PRIMARY KEY CLUSTERED  ([Id])
GO
