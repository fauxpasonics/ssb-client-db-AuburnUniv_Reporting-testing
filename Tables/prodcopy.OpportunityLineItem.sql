...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Opportuni__copyl__5535A963] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[OpportunityLineItem] ADD CONSTRAINT [PK__Opportun__3214EC07AE800BCE] PRIMARY KEY CLUSTERED  ([Id])
GO
