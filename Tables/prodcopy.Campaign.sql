...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__Campaign__CopyLo__3E52440B] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Campaign] ADD CONSTRAINT [PK__Campaign__3214EC077FAA2718] PRIMARY KEY CLUSTERED  ([Id])
GO
