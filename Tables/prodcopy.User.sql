...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__User__copyloadda__1920BF5C] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[User] ADD CONSTRAINT [PK__User__3214EC0708730DA1] PRIMARY KEY CLUSTERED  ([Id])
GO
