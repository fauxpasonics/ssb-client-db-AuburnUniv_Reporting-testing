...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Cases__copyloadd__76969D2E] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Cases] ADD CONSTRAINT [PK__Cases__3214EC0793097B37] PRIMARY KEY CLUSTERED  ([Id])
GO
