...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__RecordTyp__copyl__1CF15040] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[RecordType] ADD CONSTRAINT [PK__RecordTy__3214EC075B11127D] PRIMARY KEY CLUSTERED  ([Id])
GO
