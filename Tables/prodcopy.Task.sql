...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Task__copyloadda__656C112C] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Task] ADD CONSTRAINT [PK__Task__3214EC074067B92E] PRIMARY KEY CLUSTERED  ([Id])
GO
