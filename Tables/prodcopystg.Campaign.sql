...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__Campaign__CopyLo__412EB0B6] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Campaign] ADD CONSTRAINT [PK__Campaign__3214EC076FEA96AF] PRIMARY KEY CLUSTERED  ([Id])
GO
