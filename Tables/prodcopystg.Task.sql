...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Task__copyloadda__628FA481] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Task] ADD CONSTRAINT [PK__Task__3214EC07C8B71A7E] PRIMARY KEY CLUSTERED  ([Id])
GO
