...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Contact__copyloa__164452B1] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopystg].[Contact] ADD CONSTRAINT [PK__Contact__3214EC07142C1154] PRIMARY KEY CLUSTERED  ([Id])
GO
