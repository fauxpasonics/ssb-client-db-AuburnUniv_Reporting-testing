...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Opportuni__copyl__5812160E] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[OpportunityLineItem] ADD CONSTRAINT [PK__Opportun__3214EC070D32F615] PRIMARY KEY CLUSTERED  ([Id])
GO
