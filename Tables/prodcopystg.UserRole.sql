...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__UserRole__copylo__6B24EA82] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[UserRole] ADD CONSTRAINT [PK__UserRole__3214EC072BFC2060] PRIMARY KEY CLUSTERED  ([Id])
GO
