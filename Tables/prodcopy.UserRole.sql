...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__UserRole__copylo__68487DD7] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[UserRole] ADD CONSTRAINT [PK__UserRole__3214EC0794879A73] PRIMARY KEY CLUSTERED  ([Id])
GO
