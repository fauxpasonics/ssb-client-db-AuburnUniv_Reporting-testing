...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__User__copyloadda__1B0907CE] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[User] ADD CONSTRAINT [PK__User__3214EC07DAB28E81] PRIMARY KEY CLUSTERED  ([Id])
GO
